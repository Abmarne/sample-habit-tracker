...
function formatComment(a) {
  ...
  return `## 🤖 Triage Agent — Engineering Brief
...
| **Type** | \`${a.type}\` |
| **Priority** | \`${a.priority}\` |
| **Ready** | ${ready ? "✅ Yes" : "⏳ Needs more info"} |
...
---
${ready ? "This issue is ready for implementation. Assign to \`@copilot\` or an engineer." : "⚠️ Needs clarification before work can begin."}

<sub>Generated by Triage Agent · powered by Claude via OpenRouter</sub>`;
}
